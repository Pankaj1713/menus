...
export default function CardOne({ image, title, description, price }: CardOneProps) {
          ...
          <div className=" bg-white  flex justify-between h-full items-start  p-4 gap-2">
            ...
            <div className=" order-1 w-[90%] ">
              <CardHeader className=" px-0 py-0 space-y-1">
                <CardTitle className="lg:text-lg md:text-base text-[14px]">{title}</CardTitle>
                <CardDescription className="text-[12px] lg:line-clamp-2 md:line-clamp-2 line-clamp-4">{description}</CardDescription>
              </CardHeader>
