  ...
  if (isDesktopp) {
    return (
      <Dialog open={open} onOpenChange={closeModel}>
        ...
        <DialogContent className={cn("sm:max-w-[425px] lg:h-[80vh] overflow-y-auto !border-none", contentClassName)}>
          <DialogHeader>
    ...
    <Drawer open={open} onOpenChange={closeModel}>
      ...
      <DrawerContent className={cn("!border-none !p-0", contentClassName)}>
        <DrawerHeader className="text-left !p-0 !m-0 ">
          <DrawerTitle className="border-none h-0 bg-slate-400 ">{title}</DrawerTitle>
