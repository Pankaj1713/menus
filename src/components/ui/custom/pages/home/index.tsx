    ...
    <div className="bg-gray-50  min-h-[200vh]">
          ...
          <>
            <div className="bg-appColor relative min-h-[40vh] flex justify-center items-center  pb-6">
              <div className="absolute top-0 left-0 right-0 bottom-0 bg-appColor opacity-50">
                <Image src={BgTexture} alt="BgTexture" className="w-full h-full object-cover" />
              </div>
            ...
            <div className=" w-full bg-gray-100 ">
              <div className=" wrapper ">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Button variant="outline" size="sm" className="text-white text-md  bg-appColor hover:bg-appColor/90 hover:text-white flex items-center gap-2">
                    Filter
                ...
                >
                  <CarouselContent className="-ml-2 md:-ml-4">
                    {[
                      ...
                      <CarouselItem key={category.name} className=" md:basis-1/3 lg:basis-1/5">
                        <div className="flex flex-col w-w-full h-fit items-center">
                          <div className="w-[172px]  h-[172px] flex justify-center items-center rounded-full bg-white shadow-sm p-2 mb-2 hover:shadow-md transition-shadow">
                            <Image src={category.image} alt={category.name} className="w-[80%] rounded-full h-[80%] object-cover" />
                          </div>
                          <span className="text-lg font-semibold  text-gray-600">{category.name}</span>
                        </div>
                      </CarouselItem>
                    ))}
                  </CarouselContent>
      ...
      <div className=" w-full lg:mt-0 md:mt-0 mt-16 bg-white ">
        <div className=" wrapper">
          ...
          <h2 className="lg:text-3xl text-2xl font-bold lg:hidden md:hidden block lg:mb-4 md:mb-4 mb-2">Make Your Selection!</h2>
          <h2 className="text-3xl font-bold lg:block md:block hidden mb-4">Recomended For You</h2>
          {
            isMobile() && (
              <>
                <div className=" w-full flex  justify-between items-center gap-2 ">
                  ...
                  <Button variant="outline" size="sm" className="text-appColor rounded-full px-0 py-0 w-10 h-10  text-md    flex items-center gap-2">
                    <Filter className="w-4 h-4" />
                  </Button>
                </div>
              </>
          ...
          <div className="lg:hidden md:hidden flex gap-6 overflow-x-auto border-b mb-6 no-scrollbar">
            {["Sandwiches", "Burgers", "Appetizers", "Quesadillas", "Beverages"].map((category) => (
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-10 md:gap-6 gap-4 lg:pb-24 pb-10">
            {Array.from({ length: 12 }).map((_, idx) => (
              <CardOne key={idx} image={Burger} title="Grilled Chicken Sandwich" description="A grilled or fried sandwich with a filling and melted cheese. A grilled or fried sandwich with a filling and double saucy flavour." price={20} />
