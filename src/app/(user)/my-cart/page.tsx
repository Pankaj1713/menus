    ...
    return (
        ...
        <div className=" wrapper mt-28 lg:mb-20 md:mb-10 mb-5 lg:w-[60%] mx-auto  space-y-6">
            ...
            <AnimateEachElement className="space-y-6">
                ...
                <Button onClick={() => router.push('/payment')} size="lg" className="w-full bg-[#C32B5C] hover:bg-[#A6224D] text-white">
                    Continue
                </Button>
            </AnimateEachElement>
        </div>
            ...
            <div className="flex relative flex-col md:flex-row md:items-start gap-4">
                <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">Lettuce, Bacon, Olives</p>
                        <Button
                            variant="ghost"
